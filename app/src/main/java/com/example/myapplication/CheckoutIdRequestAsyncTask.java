...
class CheckoutIdRequestAsyncTask {
    ...
    CheckoutIdRequestAsyncTask(int amount, CheckoutIdRequestListener listener) {
        this.listener = listener;
        requestCheckoutId(amount);
    }


    private void requestCheckoutId(final int amount) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                "http://salahalimohamed.website/tmajog/api/v1/user/checkout?amount=" + amount,
